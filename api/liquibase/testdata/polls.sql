...
values  ('e142753e-bc9e-4856-a68f-e4cc9591e7b9', 527838957325778954, 'Remove Barrens', 'Remove Barrens from existence', '2025-10-28 22:35:41.737529 +00:00', 'World'),
        ...
        ('92a3b4c5-d6e7-42f0-9b78-99aabbccdd10', 1000000000000000020, 'Threat API for addons', 'Expose read-only threat values for better tanking tools.', '2025-10-28 22:36:45 +00:00', 'Addons');
